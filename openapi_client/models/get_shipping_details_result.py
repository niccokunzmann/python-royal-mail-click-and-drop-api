...
class GetShippingDetailsResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["shippingCost", "trackingNumber", "shippingTrackingStatus", "serviceCode", "shippingService", "shippingCarrier", "receiveEmailNotification", "receiveSmsNotification", "guaranteedSaturdayDelivery", "requestSignatureUponDelivery", "isLocalCollect", "shippingUpdateSuccessDate", "packages"]
