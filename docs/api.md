...
------------ | ------------- | ------------- | -------------
*CarriersApi* | [**get_carriers_async**](./CarriersApi.md#get_carriers_async) | **GET** /carriers | Retrieve list of carriers for the account
...
*ReturnsApi* | [**returns_post**](./ReturnsApi.md#returns_post) | **POST** /returns | Create a return shipment
*ReturnsApi* | [**returns_services_get**](./ReturnsApi.md#returns_services_get) | **GET** /returns/services | List available return services
...
## Documentation For Models
 ...
 - [CreateReturnRequest](./CreateReturnRequest.md)
 - [CreateReturnResponse](./CreateReturnResponse.md)
 - [CreateReturnResponseShipment](./CreateReturnResponseShipment.md)
 - [CustomerReference](./CustomerReference.md)
 ...
 - [GetCarrierResource](./GetCarrierResource.md)
