...
class CreateReturnResponseShipment(BaseModel):
    """
    CreateReturnResponseShipment
    """ # noqa: E501
    tracking_number: Optional[StrictStr] = Field(default=None, alias="trackingNumber")
    unique_item_id: Optional[StrictStr] = Field(default=None, alias="uniqueItemId")
    __properties: ClassVar[List[str]] = ["trackingNumber", "uniqueItemId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uniqueItemId": obj.get("uniqueItemId")
        })
        return _obj
