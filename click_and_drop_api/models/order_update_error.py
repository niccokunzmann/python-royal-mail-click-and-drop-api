...
class OrderUpdateError(BaseModel):
    ...
    __properties = ["orderIdentifier", "orderReference", "status", "code", "message"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderUpdateError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderUpdateError:
        """Create an instance of OrderUpdateError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderUpdateError.parse_obj(obj)

        _obj = OrderUpdateError.parse_obj({
