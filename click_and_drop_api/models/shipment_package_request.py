...
class ShipmentPackageRequest(BaseModel):
    ...
    package_format_identifier: StrictStr = Field(description="<b>If you have a ChannelShipper account, you can also pass the name of any of your custom package formats instead of the values below.</b><br> Enum: 'undefined', 'letter', 'largeLetter', 'smallParcel', 'mediumParcel', 'largeParcel', 'parcel', 'documents'", alias="packageFormatIdentifier")
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.contents:
            for _item_contents in self.contents:
                _items.append(_item_contents.to_dict() if _item_contents is not None else None)
