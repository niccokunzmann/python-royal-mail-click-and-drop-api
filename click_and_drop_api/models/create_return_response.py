...
class CreateReturnResponse(BaseModel):
    ...
    """ # noqa: E501
    shipment: Optional[CreateReturnResponseShipment] = None
    qr_code: Optional[StrictStr] = Field(default=None, alias="qrCode")
    label: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["shipment", "qrCode", "label"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shipment": CreateReturnResponseShipment.from_dict(obj["shipment"]) if obj.get("shipment") is not None else None,
