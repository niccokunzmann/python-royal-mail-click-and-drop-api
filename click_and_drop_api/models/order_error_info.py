...
class OrderErrorInfo(BaseModel):
    ...
    __properties = ["orderIdentifier", "orderReference", "code", "message"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderErrorInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderErrorInfo:
        """Create an instance of OrderErrorInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderErrorInfo.parse_obj(obj)

        _obj = OrderErrorInfo.parse_obj({
