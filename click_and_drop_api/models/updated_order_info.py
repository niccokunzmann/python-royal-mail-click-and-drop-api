...
class UpdatedOrderInfo(BaseModel):
    ...
    __properties = ["orderIdentifier", "orderReference", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdatedOrderInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdatedOrderInfo:
        """Create an instance of UpdatedOrderInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdatedOrderInfo.parse_obj(obj)

        _obj = UpdatedOrderInfo.parse_obj({
