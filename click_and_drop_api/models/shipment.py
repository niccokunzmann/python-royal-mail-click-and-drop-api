...
class Shipment(BaseModel):
    ...
    return_address: Address = Field(alias="returnAddress")
    customer_reference: Optional[CustomerReference] = Field(default=None, alias="customerReference")
    __properties: ClassVar[List[str]] = ["shippingAddress", "returnAddress", "customerReference"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of customer_reference
        if self.customer_reference:
            _dict['customerReference'] = self.customer_reference.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customerReference": CustomerReference.from_dict(obj["customerReference"]) if obj.get("customerReference") is not None else None
        })
        return _obj
