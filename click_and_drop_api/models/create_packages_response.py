...
class CreatePackagesResponse(BaseModel):
    ...
    __properties = ["packageNumber", "trackingNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePackagesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePackagesResponse:
        """Create an instance of CreatePackagesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePackagesResponse.parse_obj(obj)

        _obj = CreatePackagesResponse.parse_obj({
            "package_number": obj.get("packageNumber"),
