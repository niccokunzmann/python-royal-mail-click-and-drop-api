...
class CarriersApi:
    ...
    def get_carriers_async(
        ...
        _param = self._get_carriers_async_serialize(
    ...
    @validate_call
    def get_carriers_async_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetCarrierResource]]:
        """Retrieve list of carriers for the account
    ...
    @validate_call
    def get_carriers_async_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_carriers_async_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
